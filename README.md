...
表示された選択肢からCodexまたはClaude Codeを選びます。未ログインなら、このPCの公式ログイン画面か、スマホを使う方法を選べます。Orbitory自体はパスワードやOAuthトークンを受け取りません。
